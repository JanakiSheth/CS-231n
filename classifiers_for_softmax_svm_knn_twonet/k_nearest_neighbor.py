...
class KNearestNeighbor(object):
  ...
  def compute_distances_no_loops(self, X):
    ...
    dists = np.sqrt(X_test_square.reshape(X_test_square.shape[0],1) - 2* X.dot(self.X_train.T) + X_train_square.reshape(X_train_square.shape[0],1).T)
    #########################################################################
    #                         END OF YOUR CODE                              #
    #########################################################################
    return dists
  ...
  def predict_labels(self, dists, k=5):
    ...
    for i in range(num_test):
      ...
      closest_y = self.y_train[dists_ind[0:k]]
       #########################################################################
      # TODO:                                                                 #
